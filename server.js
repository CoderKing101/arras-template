...
class io_fireGunsOnAlt extends IO {
        constructor(b) {
            super(b);
        }
        think(input) {
...
class io_reverseheli extends IO {
    constructor(b) {
        super(b);
        this.a = 0;
    }
    ...
    think(input) {
        if (input.alt && input.target) {
            if (this.body.cameraOverrideX === null) {
                ...
                this.body.cameraOverrideFoV = this.body.fov * this.body.solitaireScale
            }
        } else {
            this.body.cameraOverrideX = null;
            this.body.cameraOverrideY = null;
            this.body.cameraOverrideFoV = null;
        }
    }
}
class io_enlarge extends IO {
    constructor(body) {
        super(body);
        this.distance = 250;
    }
...
class io_canMegaZoom extends IO {
    constructor(body) {
        super(body);
        this.distance = 500;
    }
...
const levelers = [
    ...
    31, 32, 33, 34, 35, 36, 38, 40, 42, 44, 45, 46,
];
class Skill {
...
var maintainloop = (() => {
    ...
    let spawnCrasher = census => {
        if (ran.chance(1 -  0.5 * census.crasher / room.maxFood / room.nestFoodAmount)) {
            ...
            let type = (ran.dice(80)) ? ran.choose([Class.sentryGun, Class.sentrySwarm, Class.sentryTrap]) : ran.choose([Class.crasher, Class.seman, Class.obturate, Class.resiler]);
            let o = new Entity(spot);
                o.define(type);
                o.team = -100;
        }
        ...
        return () => {
            ...
            // Bots
                if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                    o.define((ran.dice(80)) ? ran.choose([Class.judder, Class.clino, Class.nephograph, Class.enthymeme, Class.armi, Class.maskirovka, Class.oxy, Class.falcate, Class.clatfart, Class.audile, Class.trangam, Class.scope, Class.betise, Class.jiboya, Class.chalcography, Class.astro, Class.barb, Class.xylor, Class.blackguard, Class.hastate, Class.kimset, Class.tonga, Class.dry, Class.dino, Class.sphero, Class.pseudacasis, Class.anhedonia, Class.quarion, Class.cairn, Class.quinti, Class.lenti, Class.braird, Class.aph, Class.dilace, Class.third, Class.tag, Class.tuist, Class.verti, Class.affray, Class.vector, Class.urano, Class.chrone, Class.gyno, Class.austro, Class.nephogram, Class.gardy, Class.libri, Class.tagSecond, Class.oom, Class.vivency, Class.pykno, Class.hypo, Class.ergo, Class.para, Class.kerato, Class.whin, Class.scia, Class.zoola, Class.brad, Class.arcto, Class.eroto, Class.requiem, Class.zym, Class.ovi, Class.fleam, Class.willi, Class.hybridautosmash]) : ran.choose([Class.judder, Class.clino, Class.nephograph, Class.enthymeme, Class.armi, Class.maskirovka, Class.oxy, Class.falcate, Class.clatfart, Class.audile, Class.trangam, Class.scope, Class.betise, Class.jiboya, Class.chalcography, Class.astro, Class.barb, Class.xylor, Class.blackguard, Class.hastate, Class.kimset, Class.tonga, Class.dry, Class.dino, Class.sphero, Class.pseudacasis, Class.anhedonia, Class.quarion, Class.cairn, Class.quinti, Class.lenti, Class.braird, Class.aph, Class.dilace, Class.third, Class.tag, Class.tuist, Class.verti, Class.affray, Class.vector, Class.urano, Class.chrone, Class.gyno, Class.austro, Class.nephogram, Class.gardy, Class.libri, Class.tagSecond, Class.oom, Class.vivency, Class.pykno, Class.hypo, Class.ergo, Class.para, Class.kerato, Class.whin, Class.scia, Class.zoola, Class.brad, Class.arcto, Class.eroto, Class.requiem, Class.zym, Class.ovi, Class.fleam, Class.willi, Class.hybridautosmash]));
